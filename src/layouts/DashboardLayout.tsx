...
import PilotModeLayout from './PilotModeLayout';

import { ConnectionsSidebar } from '@/components/connections/ConnectionsSidebar';
import ControlPanel from '@/components/control/ControlPanel';
import IMUCard from '@/components/telemetry/imu/IMUCard';
import LidarCard from '@/components/telemetry/lidar/LidarCard';
import TopicsList from '@/components/telemetry/topics/TopicsList';
import {
  ResizableHandle,
  ResizablePanel,
  ResizablePanelGroup,
