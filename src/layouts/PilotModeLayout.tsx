...
import PilotModeLayoutDesktop from '@/components/pilot-mode/layout/PilotModeLayoutDesktop';
import PilotModeLayoutMobile from '@/components/pilot-mode/layout/PilotModeLayoutMobile';
