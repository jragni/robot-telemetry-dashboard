...
/** PilotStatusBar
 * @description Renders the battery and dual connection status indicators in a
 *  compact HUD overlay panel. Shows independent status for rosbridge
 *  (controls/telemetry) and video (WebRTC) connections.
