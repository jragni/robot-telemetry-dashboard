...
export const COMPASS_STRIP_HEIGHT = 28;
export const COMPASS_TICK_HEIGHT_MAJOR = 8;
export const COMPASS_TICK_HEIGHT_MINOR = 4;
export const COMPASS_POINTER_HALF_WIDTH = 4;
export const COMPASS_POINTER_HEIGHT = 5;
