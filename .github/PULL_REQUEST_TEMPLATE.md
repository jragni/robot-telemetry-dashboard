...
Target branch: the active EPIC branch (never main directly).
...
<!--
Dispatch matrix is in docs/PR-REVIEW.md. Fill counts after the reviewer agents return.
...
- [ ] Base branch = active EPIC (never `main` directly)
