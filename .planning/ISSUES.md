...
### ISS-004: CLOSED — Panel resize cursor feedback addressed (Phase 14-02, commit 89d0d2c)

### ISS-005: CLOSED — Layout toolbar UX redesigned as context menu (Phase 14-03, commit 39a8d61)

### ISS-006: CLOSED — Sidebar toggle moved below Header (Phase 14-04, commit bc82dda)

### ISS-008: CLOSED — Panel grid infinite growth fixed, hotfix outside GSD (commit 2696357)
