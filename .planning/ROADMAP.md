...
- [ ] **Phase 13.1: ConditionalRender + Code Style + One-Way Data Flow** — ConditionalRender component, [].includes() pattern, promote cross-feature imports to shared layer (INSERTED)
